...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.normal(0, weight_scale, (num_filters*H*W//4, hidden_dim)) # // 4 for max pool
    ...
    def loss(self, X, y=None):
        ...
        out4, cache4 = affine_forward(out3, self.params['W3'], self.params['b3'])
        scores = out4
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        # bp grads
        dout3, grads['W3'], grads['b3'] = affine_backward(dout, cache4)
        dout2 = relu_backward(dout3, cache3)
        dout2, grads['W2'], grads['b2'] = affine_backward(dout2, cache2)
